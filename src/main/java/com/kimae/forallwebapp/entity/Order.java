...
public class Order {
    ...
    private static Integer id_pedido;
    ...
    private Order(Integer id_loja, Float frete, Payment pagamento, List<OrderItem> itens,DataFormatter formatter) {
        id_pedido++;
    ...
    public static Order defaultOrderSerializable(List<OrderItem> itens){
        ...
        return new Order(1, 5f, Payment.defaultPaymentForm(), itens, new SerializationFormatter());
    }
    ...
    public static Integer getId_pedido() {
        return id_pedido;
    }
